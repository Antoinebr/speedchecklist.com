    ...
    <div class="container  u-ptl u-plm u-prm">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 u-mtn  hero-container">
            ...
            <img v-if="reco.acf.illustration" :src="reco.acf.illustration_file" class="icon">
...
export default {
  ...
  methods:{
    ...
    forceHighlightning(){
      ...
      for ( let i = 0; i < block.length; i++ ) hljs.highlightBlock(block[i]);
    },
  ...
  created(){
    ...
    setTimeout( () => this.forceHighlightning(), 1000);
